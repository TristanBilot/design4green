...
$childborder-color: $primary-border-color;
$error-elem-color: $primary-border-color;
...
$treegrid-rowdrag-childborder-border: 2px solid $primary-border-color;
$treegrid-rowdd-topbottom-border: 2px solid $primary-border-color !default;
